...
export default function Cart({ books, cart, changeQuantity, removeItem }) {
  const subTotal = () => {
    return cart.reduce((total, book) => total + book.quantity * (book.salePrice || book.originalPrice), 0)
  };
                  ...
                  return (
                    <div className="cart__item">
                      ...
                      <div className="cart__quantity">
                        <input type="number" name="cart-quantity" min={0} max={99} value={book.quantity} onChange={(event) => changeQuantity(book, event.target.value)} className="cart__input" />
                      </div>
